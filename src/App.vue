...
<template>
  ...
  <template v-else>
    <header v-if="authStore.user" class="p-4 bg-white shadow-sm flex justify-between items-center sticky top-0 z-50">
    ...
    <nav v-if="authStore.user" class="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 flex justify-around items-center z-40 pb-safe">
